...
class Logger:
  ...
  def debug(self, text: any, title: str = "DEBUG") -> None:
    ...
    """
    if self.debug_mode:
      print(f"\033[94m[{self._date_()}] {title.upper()}: {str(text)}\033[0m")
  ...
  def comment(self, text: any, title: str = "COMMENT") -> None:
    ...
    """
    print(f"\033[93m[{self._date_()}] {title.upper()}: {str(text)}\033[0m")
  ...
  def info(self, text: any, title: str = "INFO") -> None:
    ...
    """
    print(f"\033[96m[{self._date_()}] {title.upper()}: {str(text)}\033[0m")
  ...
  def error(self, text: any, title: str = "ERROR") -> None:
    ...
    """
    print(f"\033[91m{self._date_()}] {title.upper()}: {str(text)}\033[0m")
